        ...
        <div className="container custom-container">
            ...
            <div className="w-full lg:pe-12 md:w-1/2 lg:w-4/12 xl:w-5/12 z-10">
              <div className="mb-0 max-w-[360px] lg:mb-0">
                <Link href="/" className="mb-4 inline-block">
                  <Image
                    src="/images/logo/nav-logo-01.svg"
                    alt="logo"
                    className="w-32"
                    width={100}
                    height={30}
                ...
                <p className="mb-0 text-base leading-relaxed brand-text-secondary dark:text-body-color-dark">
                  Resident Architects Limited is a consultancy firm registered in Kampala, Uganda specializing in
                  Architecture, Interior design, Landscape design and Project Management.
                </p>
              </div>
            </div>
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      ...
                      className="mb-4 inline-block text-base brand-text-secondary duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      +256 0393208189 | +256 783003098 | +256 709 688150
                    </Link>
                  </li>
                </ul>
          ...
          <div className="py-4">
            <p className="text-center text-base text-body-color">
              &copy; {currentYear} Resident Architects Limited. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
