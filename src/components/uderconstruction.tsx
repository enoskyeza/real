...
export default function Uderconstruction() {
    return (
        <>
            <div className="w-full h-screen flex flex-col items-center justify-between bg-white">
                ...
                <div className="w-full py-4 border-t-2 border-amber-900 bg-brand-primary">
                    <div
                        className="container mx-auto flex flex-col md:flex-row items-center justify-center text-white text-sm md:space-x-8 space-y-1 md:space-y-0">
                        ...
                        <a href="#" className="flex items-center space-x-1" target="_blank" title="Call">
                            ...
                            <span>+256 393208189 | +256 783 003098</span>
                        </a>
                        <a href="#" className="flex items-center space-x-1" target="_blank" title="Email">
                            ...
                            <span>info@real.ug</span>
                        </a>
                    </div>

                </div>
            </div>
        <div className="absolute left-0 top-0 bg-blue-950 z-[-1] opacity-30 lg:opacity-100">
        {/* am thinking the background image to go in this section and the 2 section*/}
        </div>
