  ...
  return (
    <>
      ...
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="max-w-[600px] text-center md:text-left">
                ...
                {/*</p>*/}
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  {/*From pencil concept to built reality in East Africa. We transform visions into landmarks.*/}
        ...
        <div className="bob-2 absolute z-10 bottom-4 -left-12 w-32 h-32 md:bottom-8 md:-left-24 md:h-48 md:w-48 rounded-full bg-peach opacity-100"></div>
        <div className="bob-3 absolute z-10 -top-12 -right-16 w-48 h-48 md:-top-48 md:right-[20%] md:h-96 md:w-96 rounded-full bg-peach opacity-100"></div>
      </section>
    </>
  );
};
